...
public	ResultsPanel () {
	...
	activityTextField.setText(list.listOfNames(list));
	
	
	durationTextField = new JTextField(0);
	durationTextField.setPreferredSize(new Dimension(80, 80));
	durationTextField.setText(Integer.toString(list.getDuration()));
...
private class ButtonListener implements ActionListener
{
 public void actionPerformed (ActionEvent event)
	 ...
	 if(event.getSource() == resetButton) {
		 ...
		 //need to clear the data stored in list as well
